  ...
  return (
    <div className="min-h-screen flex pt-20">
      ...
      <main className="flex-1 p-6">
        <h1 className="text-2xl font-bold text-emerald-700">Rejected Loan Requests</h1>
        <p className="mt-2 text-gray-600">List of rejected loan applications will appear here.</p>
          ...
          <table className="min-w-full text-left table-auto">
            ...
            <tbody>
              {rejectedLoans.length === 0 ? (
                <tr>
                  <td colSpan="5" className="px-4 py-2 text-center text-gray-600">No rejected loan requests found.</td>
                </tr>
              ) : (
                rejectedLoans.map((loan) => (
                  <tr key={loan.id}>
                    ...
                    <td className="px-4 py-2 text-red-500">{loan.status}</td>
                  </tr>
                ))
              )}
            </tbody>
